...
class AnimesControllerTest < ActionController::TestCase
  ...
  test "should create anime" do
    assert_difference('Anime.count') do
      post :create, anime: { episodes: @anime.episodes, progress: @anime.progress, score: @anime.score, status: @anime.status, title: @anime.title }
    end
  ...
  test "should update anime" do
    patch :update, id: @anime, anime: { episodes: @anime.episodes, progress: @anime.progress, score: @anime.score, status: @anime.status, title: @anime.title }
    assert_redirected_to anime_path(assigns(:anime))
  end
